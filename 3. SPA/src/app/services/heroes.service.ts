...
export class HeroesService {
  ...
  constructor() {
   ...
   getHeroe(idx:string){
     console.log("getHeroe: "+idx)
     //Return getHeroe for id
     //return this.heroes[idx];
     let heroesArr:Heroe[] = [];
     for (let heroe of this.heroes) {
       if (heroe.id==idx) {
         console.log("COndicion: "+heroe.id +"-----"+idx)
